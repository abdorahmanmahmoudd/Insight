...
class QuestionCompleteViewController: ParentViewController, UITableViewDelegate, UITableViewDataSource, CorrectedQuestion, UITextViewDelegate, AdvancedQuestion, UITextFieldDelegate {
